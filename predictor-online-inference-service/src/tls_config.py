...
class TLSConfigManager:
    ...
    def __init__(
        self,
        kafka_tls_config: Optional[TLSConfig] = None,
        redis_tls_config: Optional[TLSConfig] = None,
        postgres_tls_config: Optional[TLSConfig] = None,
    ):
        """
    ...
    def create_ssl_context(self, tls_config: TLSConfig) -> Optional[ssl.SSLContext]:
        """
    ...
    def validate_certificates(self) -> bool:
        ...
        if self.redis_tls_config.enabled:
            if self.redis_tls_config.ca_cert_path:
        ...
        if self.postgres_tls_config.enabled:
            if self.postgres_tls_config.ca_cert_path:
