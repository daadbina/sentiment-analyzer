...
class FeatureEngineer:
    ...
    def engineer_features(
        ...
        Raises:
            DataPreparationError: If feature engineering fails
        """
        with tracer.start_as_current_span("engineer_features"):
            try:
    ...
    def _generate_interaction_features(self, X: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        with tracer.start_as_current_span("generate_interaction_features"):
            try:
                self.interaction_feature_names = []
    ...
    def _generate_polynomial_features(
        ...
        """
        with tracer.start_as_current_span("generate_polynomial_features"):
            try:
                if fit:
